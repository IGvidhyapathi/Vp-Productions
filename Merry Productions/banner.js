        ...
        function showEndImage() {
          ...
          var video09 = document.getElementById("video9");
          var bg09 = document.getElementById("bg");
  
          function showEndImage() {
              video09.style.display = "none"; // Hide the video
              bg09.style.display = "block"; // Show the image
            }
            video03.addEventListener("ended", showEndImage);
        ...
        var muteButton = document.getElementById("muteButton9");
    
        muteButton.addEventListener("click", function() {
            if (video9.muted) {
                video9.muted = false; // Unmute the video
                muteButton.textContent = "Mute";
            } else {
                video9.muted = true; // Mute the video
                muteButton.textContent = "Unmute";
            }
        });
